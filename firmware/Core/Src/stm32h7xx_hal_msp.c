...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC4     ------> ADC1_INP4
    */
    GPIO_InitStruct.Pin = ESC_C_Pin|ESC_V_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC4     ------> ADC1_INP4
    */
    HAL_GPIO_DeInit(GPIOC, ESC_C_Pin|ESC_V_Pin);
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  else if(htim_pwm->Instance==TIM5)
  {
    ...
    /* TIM5 DMA Init */
    /* TIM5_CH1 Init */
    hdma_tim5_ch1.Instance = DMA1_Stream4;
    ...
    /* TIM5_CH2 Init */
    hdma_tim5_ch2.Instance = DMA1_Stream5;
    ...
    /* TIM5_CH3 Init */
    hdma_tim5_ch3.Instance = DMA1_Stream6;
    ...
    __HAL_LINKDMA(htim_pwm,hdma[TIM_DMA_ID_CC3],hdma_tim5_ch3);

    /* TIM5_CH4 Init */
    hdma_tim5_ch4.Instance = DMA1_Stream7;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = M_5_Pin|M_6_Pin|M_7_Pin|M_8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = AUX_L3_Pin|AUX_L4_Pin|AUX_S1_Pin|AUX_S2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM4)
  {
    ...
    PD13     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = AUX_L1_Pin|AUX_L2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PE8     ------> UART7_TX
    */
    GPIO_InitStruct.Pin = ESC_TELEM_Pin|EXPOSED_UART7_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = COMPANION_CTS_Pin|COMPANION_RTS_Pin|COMPANION_TX_Pin|COMPANION_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART7)
  {
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOE, ESC_TELEM_Pin|EXPOSED_UART7_TX_Pin);
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, COMPANION_CTS_Pin|COMPANION_RTS_Pin|COMPANION_TX_Pin|COMPANION_RX_Pin);
