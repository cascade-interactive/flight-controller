...
namespace CoreMath {
	...
	struct Vector3 {
		...
		[[nodiscard]] inline static Vector3 Zero()    { return Vector3(0.0f, 0.0f, 0.0f); }
		[[nodiscard]] inline static Vector3 One()     { return Vector3(1.0f, 1.0f, 1.0f); }
		[[nodiscard]] inline static Vector3 Up()      { return Vector3(0.0f, 0.0f, 1.0f); }
		[[nodiscard]] inline static Vector3 Forward() { return Vector3(1.0f, 0.0f, 0.0f); }
